...
$id = $args['id'] ?: 'checkbox-' . wp_unique_id();
...
$checkbox_classes = implode( ' ', array_filter( [
    'rounded border-gray-300 focus:ring-2 focus:ring-offset-2 transition-colors cursor-pointer',
